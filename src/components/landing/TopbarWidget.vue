...
<template>
    <a class="flex items-center" href="#">
        <img src="/demo/images/logo.png" class="h-20 w-auto mr-1" />
        <span class="text-surface-900 dark:text-surface-0 font-medium text-2xl leading-normal mr-20">BlutTruck</span>
    </a>
    <Button
        class="lg:!hidden"
        text
